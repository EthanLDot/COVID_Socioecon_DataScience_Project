...
def clean_labor_data():
    ...
    #Read excel file, renames first column to States and take out null rows
    raw_labor_data = pd.read_excel("Group029-Wi22/Raw_Data/collar_dataset_raw.xlsx", header = 4)
    ...
    #export as csv
    labor_data.to_csv('Group029-Wi22/Cleaned Data/state_labor_data.csv')
